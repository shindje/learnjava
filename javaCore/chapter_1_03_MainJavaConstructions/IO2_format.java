...
public class IO2_format {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.printf("%,0+20f", 232424f);	//+00000232�424,000000
		...
		System.out.println();
		System.out.printf("%tc seconds: %<ts millisecond: %<tQ ", new Date());	//�� ��� 01 18:12:31 EET 2016 seconds: 1470067951 millisecond: 1470067951173 
